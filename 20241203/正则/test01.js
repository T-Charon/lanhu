...
//1.编写一个正则表达式，匹配一个格式正确的IPv4地址。255.255.255.255 /  0.0.0.0  / 192.168.1.1 / 127.0.0.1
var IP ="1.1.1.1"
//var regIP=/(?=([255|0]{3}).)/
var ipv4Reg=/([0-9]{3}. )| ([1-9][0-9]{3}.)/
console.log(ipv4Reg.test("255.1.1.1"))
//2.编写个正则表达式，匹配一个格式正确的日期（年份为四位数，月份和日期为两位数）。
